package zhangyanran20181017.bwie.com.day13.adapter;
...
import zhangyanran20181017.bwie.com.day13.holder.MyViewHolder;
import zhangyanran20181017.bwie.com.day13.mvp.view.WebActivity;
...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public void addData(List<NewBean.DataBean> list,boolean isFresh){
        if (list!=null) {
            if(isFresh) {
                this.list.clear();
            }
    ...
    /*public List<NewBean.DataBean> getData() {
        return list;
    }*/
